 ...
 * allow_permission for the {@link com.ushahidi.platform.mobile.app.data.entity.PostEntity}
 * value field in the table without de-serializing it.
 *
 * @author Ushahidi Team <team@ushahidi.com>
 */
public class PostPublishToEntityFieldConverter<T> implements FieldConverter<T> {
     ...
     * @param gson The gson
     */
    public PostPublishToEntityFieldConverter(Type type, Gson gson) {
        mType = type;
        mGson = gson;
    }
