...
import com.ushahidi.platform.mobile.app.domain.usecase.post.SearchPostUsecase;
...
public class SearchPostPresenter implements Presenter {
    ...
    /**
     * Perform a search based  {@link com.ushahidi.platform.mobile.app.presentation.model.PostModel} the query
     * passed to it
     *
