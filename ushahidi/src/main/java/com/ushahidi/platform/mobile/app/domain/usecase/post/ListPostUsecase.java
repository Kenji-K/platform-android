...
/**
 * Use case for listing {@link com.ushahidi.platform.mobile.app.domain.entity.Post}
 *
...
public class ListPostUsecase extends Usecase {
    ...
    /**
     * Sets the deployment ID to be used to fetch the {@link com.ushahidi.platform.mobile.app.domain.entity.Post}
