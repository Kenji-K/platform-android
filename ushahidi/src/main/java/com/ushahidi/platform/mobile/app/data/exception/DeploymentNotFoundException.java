...
/**
 * Exception thrown by {@link com.ushahidi.platform.mobile.app.data.database.DeploymentDatabaseHelper} when a
 * {@link com.ushahidi.platform.mobile.app.data.entity.DeploymentEntity} can't be found from the database.
 *
