...
/**
 * Exception thrown by {@link com.ushahidi.platform.mobile.app.data.database.GeoJsonDatabaseHelper} when a
 * {@link com.ushahidi.platform.mobile.app.data.entity.GeoJsonEntity} can't be found from the database.
 *
