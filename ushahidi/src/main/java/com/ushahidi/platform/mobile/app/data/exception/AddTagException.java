...
/**
 * Exception thrown by the application when a {@link com.ushahidi.platform.mobile.app.data.database.TagDatabaseHelper}
 * when a {@link com.ushahidi.platform.mobile.app.data.entity.TagEntity} can't be added to the database.
 *
