...
/**
 * Get {@link com.ushahidi.platform.mobile.app.domain.entity.Deployment} use case
 *
...
public class GetDeploymentUsecase extends Usecase {
    ...
    /**
     * Sets the deployment id to be used to fetch the {@link com.ushahidi.platform.mobile.app.domain.entity.Deployment}
     *
