...
/**
 * * Exception thrown by {@link com.ushahidi.platform.mobile.app.data.database.TagDatabaseHelper} when a
 * {@link com.ushahidi.platform.mobile.app.data.entity.TagEntity} can't be found from the database.
 *
