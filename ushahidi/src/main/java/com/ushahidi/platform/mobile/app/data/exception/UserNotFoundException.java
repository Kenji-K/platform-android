...
/**
 * * Exception thrown by {@link com.ushahidi.platform.mobile.app.data.database.UserDatabaseHelper} when a
 * {@link com.ushahidi.platform.mobile.app.data.entity.UserEntity} can't be found from the database.
 *
