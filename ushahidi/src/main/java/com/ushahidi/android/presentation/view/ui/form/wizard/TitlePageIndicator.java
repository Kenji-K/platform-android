 ...
 * also scrolled.
 *
 * This is based of works of others listed above. Slightly modified to offer different colors
 * support for the underline color and the text. Also modified so the underline spans to the
 * length of the text.
 *
 * LOTS of clean up to match coding style
 */
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    private int mSelectedFooterColor;
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultSelectedFooterColor = res
                .getColor(R.color.default_title_indicator_selected_footer_color);
        ...
        mSelectedFooterColor = a
                .getColor(R.styleable.TitlePageIndicator_selectedFooterColor,
    ...
    public void setSelectedFooterColor(int selectedFooterColor) {
        mPaintFooterIndicator.setColor(selectedFooterColor);
        invalidate();
    }
    ...
    @Override
    public void onPageTitleSelected(int position) {
    ...
    public enum IndicatorStyle {
        /** No style */
        None(0),
        /** Draw a triangle as the indicator */
        Triangle(1),
        /** Draw an underline as the indicator */
        Underline(2);
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Creates a parcelable {@link SavedState}
         */
